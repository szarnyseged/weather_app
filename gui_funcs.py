...
class Forecast:
    ...
    @classmethod
    def show_image(cls, window, image, row=0, column=0):
        """
...
class FiveDayForecast(Forecast):
    ...
    def fill_data(cls, datas):
        ...
        if day == "Monday":
            if time == "00:00:00":
                ...
                column1_dict["Label_row1_column1"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 1))
                ...
                column1_dict["Label_row4_column1"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 1))
                ...
                column1_dict["Label_row7_column1"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 1))
                ...
                column1_dict["Label_row10_column1"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 1))
            ...
            if time == "00:00:00":
                column2_dict["Label_row1_column2"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 2))
                ...
                column2_dict["Label_row4_column2"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 2))
                ...
                column2_dict["Label_row7_column2"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 2))
                ...
                column2_dict["Label_row10_column2"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 2))
            ...
            if time == "00:00:00":
                column3_dict["Label_row1_column3"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 3))
                ...
                column3_dict["Label_row4_column3"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 3))
                ...
                column3_dict["Label_row7_column3"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 3))
                ...
                column3_dict["Label_row10_column3"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 3))
            ...
            if time == "00:00:00":
                column4_dict["Label_row1_column4"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 4))
                ...
                column4_dict["Label_row4_column4"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 4))
                ...
                column4_dict["Label_row7_column4"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 4))
                ...
                column4_dict["Label_row10_column4"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 4))
            ...
            if time == "00:00:00":
                column5_dict["Label_row1_column5"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 5))
            ...
            if time == "06:00:00":
                column5_dict["Label_row4_column5"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 5))
            ...
            if time == "12:00:00":
                column5_dict["Label_row7_column5"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 5))
            ...
            if time == "18:00:00":
                column5_dict["Label_row10_column5"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 5))
            ...
            if time == "00:00:00":
                column6_dict["Label_row1_column6"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 6))
                ...
                column6_dict["Label_row4_column6"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 6))
                ...
                column6_dict["Label_row7_column6"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 6))
                ...
                column6_dict["Label_row10_column6"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 6))
            ...
            if time == "00:00:00":
                column7_dict["Label_row1_column7"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 1, 7))
                ...
                column7_dict["Label_row4_column7"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 4, 7))
                ...
                column7_dict["Label_row7_column7"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 7, 7))
                ...
                column7_dict["Label_row10_column7"].config(image=show_image(frame, resources.ICONS_BY_ID[merged_datas[index]["weather_id_list"]], 10, 7))
    ...
    def run(cls, window, frame):
        ...
        cls.setup_table(window, frame)
        cls.fill_data(merged_datas)
        pass
